        ...
        <div className="relative z-50">
            <div className="fixed top-0 left-0 right-0 h-16 backdrop-blur-xl bg-black/90 border-b-2 border-green-400/30 shadow-[0_4px_32px_0_rgba(34,197,94,0.15)]">
                <div className="h-full px-4 flex items-center justify-between">
                    {/* Sección izquierda - Logo y sidebar mobile */}
                    <div className="flex items-center gap-3">
                        {/* Mobile sidebar button - Solo visible en mobile */}
                    ...
                    {/* Sección derecha - Navegación rápida (solo desktop) y acciones */}
                    <div className="flex items-center gap-3">
                        {/* Navegación rápida - Solo visible en desktop */}
                        ...
                        {/* Navbar routes - UserButton y botones adicionales */}
                        <NavbarRoutes />
                    </div>
                </div>
            </div>
