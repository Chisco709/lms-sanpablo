    ...
    <div className="p-6 space-y-6">
      <div className="mb-8">
        ...
        <p className="text-slate-400">
          Define y sigue tus objetivos académicos
        </p>
      </div>
      ...
      <div className="text-center py-16">
        ...
        <p className="text-slate-400 mb-4">
          Pronto podrás establecer y seguir tus metas de aprendizaje personalizadas
        </p>
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4 max-w-md mx-auto">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              <p className="text-yellow-200 font-medium mb-1">Próximas funcionalidades:</p>
              <ul className="text-yellow-300/80 space-y-1 text-xs text-left">
                <li>• Establecer metas de cursos por mes</li>
