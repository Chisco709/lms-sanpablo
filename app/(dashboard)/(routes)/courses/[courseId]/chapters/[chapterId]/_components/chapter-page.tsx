...
import MobileChapterViewer from "@/components/mobile-chapter-viewer";
...
const ChapterPage = ({
  ...
  const mobileCourseData = {
    id: course.id,
    title: course.title,
    instructor: "Instituto San Pablo",
    image: "/logo-sanpablo.jpg",
    ...
    chapters: [
      {
        ...
        duration: 45 * 60, // 45 minutos en segundos
        ...
        resources: [
          ...
          ...(chapter.googleFormUrl ? [{
            name: "Formulario de entrega",
            url: chapter.googleFormUrl,
            type: "link" as const
          }] : []),
          ...attachments.map(att => ({
            name: att.name,
  ...
  return (
    <>
      ...
      <div className="block md:hidden">
        <MobileChapterViewer 
          course={mobileCourseData}
          currentChapterId={chapter.id}
          onChapterComplete={(chapterId) => {
            // Aquí puedes agregar lógica de completar capítulo
            console.log(`Completar capítulo: ${chapterId}`);
          }}
      ...
      <div className="hidden md:block min-h-screen bg-black relative">
